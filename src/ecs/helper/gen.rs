...
impl<'a> System<'a> for PlayerGen {
  ...
  fn run(&mut self, _data: Self::SystemData) {
    ...
    pos.insert(ent, Position {0: Vector3f {x: ploc.0 as f32, y: 5.0, z: ploc.1 as f32}}).expect("Failed to insert new Position");
...
pub fn add_particle_system(_world: &mut World, ) {
