...
impl Matrix4f {
  ...
  pub fn index_assign(&mut self, idx: usize, value: &Option<f32>) {
    match (idx, *value) {
      ( 0, Some(val)) => self.m00 = val,
      ( 1, Some(val)) => self.m01 = val,
      ( 2, Some(val)) => self.m02 = val,
      ( 3, Some(val)) => self.m03 = val,
      ( 4, Some(val)) => self.m10 = val,
      ( 5, Some(val)) => self.m11 = val,
      ( 6, Some(val)) => self.m12 = val,
      ( 7, Some(val)) => self.m13 = val,
      ( 8, Some(val)) => self.m20 = val,
      ( 9, Some(val)) => self.m21 = val,
      (10, Some(val)) => self.m22 = val,
      (11, Some(val)) => self.m23 = val,
      (12, Some(val)) => self.m30 = val,
      (13, Some(val)) => self.m31 = val,
      (14, Some(val)) => self.m32 = val,
      (15, Some(val)) => self.m33 = val,
      ( _, None ) => (),
      ( _, Some(_) ) => ()
    }
  }
  ...
  pub fn negate_from(&mut self, other: &Matrix4f) {
    self.m00 = -other.m00;
    self.m01 = -other.m01;
    self.m02 = -other.m02;
    self.m03 = -other.m03;
...
//  self.m01 = buf.get() as f32;
//  self.m02 = buf.get() as f32;
//  self.m03 = buf.get() as f32;
//  self.m10 = buf.get() as f32;
//  self.m11 = buf.get() as f32;
//  self.m12 = buf.get() as f32;
//  self.m13 = buf.get() as f32;
//  self.m20 = buf.get() as f32;
//  self.m21 = buf.get() as f32;
//  self.m22 = buf.get() as f32;
//  self.m23 = buf.get() as f32;
//  self.m30 = buf.get() as f32;
//  self.m31 = buf.get() as f32;
//  self.m32 = buf.get() as f32;
...
//}
//
//pub fn store(buf: FloatBuffer) -> Matrix {
//  buf.put(self.m00);
//  buf.put(self.m01);
//  buf.put(self.m02);
//  buf.put(self.m03);
...
//}
//
//pub fn storeTranspose(buf: FloatBuffer) -> Matrix {
//  buf.put(self.m00);
//  buf.put(self.m10);
//  buf.put(self.m20);
//  buf.put(self.m30);
...
//}
//
//pub fn store3f(buf: FloatBuffer) {
//  buf.put(self.m00);
//  buf.put(self.m01);
//  buf.put(self.m02);
//  buf.put(self.m10);
